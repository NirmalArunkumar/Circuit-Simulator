...
class Resistor {
 ...
 public:
  Resistor(string name_, double resistance_,int endpoints_[2]);  // sets name, resistance and endpoint node IDs
  ...
  int getOtherEndpoint(int nodeIndex);  // returns the other node ID that the
